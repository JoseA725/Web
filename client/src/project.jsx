    ...
    return (
        <div className="project-container">
            ...
            <div className="project-section">
                <img src="../src/assets/Game.png" alt="Online Multiplayer Game" className="project-image left" />
                <div>
            ...
            <div className="project-section">
                ...
                <img src="../src/assets/Cemex.png" alt="Machine Learning Predictive Tool" className="project-image right" />
            </div>
            <div className="project-section">
                <div>
                ...
                <img src="../src/assets/Traffic.png" alt="3D Simulation for Traffic Management" className="project-image left" />
            </div>
            <div className="project-section">
                <div>
                    <h2>Compiler</h2>
                ...
                <img src="../src/assets/Compi.png" alt="Compiler" className="project-image right" />
            </div>
        </div>
    );
}